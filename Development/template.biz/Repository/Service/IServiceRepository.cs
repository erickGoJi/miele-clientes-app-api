...
namespace mieleApp.biz.Repository.Service
{
    ...
    {
        List<dto_calendario> ServiceOrder_new(DateTime _inicio, DateTime _fin, DateTime _selected, int Actividad, int[] Categorias, int no_tecnico);
        ...
        decimal total_horas_servicio(dto_total_horas dto);
